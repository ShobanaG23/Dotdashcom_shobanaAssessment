...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext){		
		...
		htmlReporter.config().setDocumentTitle("Dotdashcom_shobanaAssessment Automation Report"); // Tile of report
		htmlReporter.config().setReportName("Dotdashcom_shobanaAssessment Functional Testing"); // name of the report
